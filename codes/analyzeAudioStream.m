function [outputArg1] = analyzeAudioStream(audioStream, templateSignal, mChirpInsertStartTimeindex, templateChirpStartFrequency, templateChirpStopFrequency)
...
for i = 1 : mAudioStreamGccWindowStartIndexArrayCounts
    ...
    if i == 0
        ...
        plot(plotAxis, mGccSimilarityTimeDomainAbs, 'Marker', 'o');
    end
